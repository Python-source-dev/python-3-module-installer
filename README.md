...
client = ModuleInstaller(options)
...
client.install_modules(remote_path="dir1/file1", local_path="~/Documents/file1")
client.install_modules(remote_path="dir1/dir2/", local_path="~/Documents/dir2/")
```
...
from installer.install import WebDavException
